...
<head>
  ...
  <link rel="stylesheet" href="/views/sources/css/theme.css" type="text/css">
</head>
...
<body style="" class="bg-light my-0">
  <div class="py-0 text-center bg-light my-0" style="background-image: linear-gradient(to bottom, rgba(0,0,0,0.2), rgba(0,0,0,0.8));	background-position: top left;	background-size: 100%;	background-repeat: repeat;">
    <div class="container-fluid w-100">
      <div class="row w-100 my-5">
        <div class="col-md-8 w-100" style="	background-image: url(/views/sources/img/capa.jpg);	background-position: center;	background-size: 100%;	background-repeat: no-repeat;"></div>
        <div class="mx-auto col-md-4 col-10 bg-transparent p-5" style="">
          <img class="img-fluid d-block my-3 mx-auto" src="/views/sources/img/logo2.png">
  ...
  <div class="py-3 bg-dark text-light my-0">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 text-center">
          <p class="mb-0 text-left">© 2019 Sistic. Todos direitos reservados</p>
        </div>
      </div>
    </div>
  </div>
