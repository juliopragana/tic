...
(function ($, AdminLTE) {
  ...
  demo_settings.append(
      ...
      + "</label>"
      + "<p>Alterar o estado da barra lateral (Abrir ou recolher)</p>"
      + "</div>"
        //Sidebar mini expand on hover toggle
      + "<div class='form-group'>"
      + "<label class='control-sidebar-subheading'>"
      + "<input type='checkbox' data-enable='expandOnHover' class='pull-right'/> "
      + "Expandir a barra lateral ao passar o mouse"
      + "</label>"
      + "<p>Deixar a barra lateral minimizada e expandir-lá ao passar o mouse</p>"
      + "</div>"
        //Control Sidebar Toggle
      + "<div class='form-group'>"
      + "<label class='control-sidebar-subheading'>"
      + "<input type='checkbox' data-controlsidebar='control-sidebar-open' class='pull-right'/> "
      + "Alternar a transação da barra lateral direita"
      + "</label>"
      + "<p>Expandir a barra lateral direita</p>"
      + "</div>"
      ...
      + "</label>"
      + "<p>Altenar a cor da barra lateral direita </p>"
      + "</div>"
  );
  ...
  var skin_red_light =
      $("<li />", {style: "float:left; width: 33.33333%; padding: 5px;"})
          ...
          + "<div><span style='display:block; width: 20%; float: left; height: 20px; background: #f9fafc;'></span><span style='display:block; width: 80%; float: left; height: 20px; background: #f4f5f7;'></span></div>"
          + "</a>"
          + "<p class='text-center no-margin' style='font-size: 12px'>Vermelho Light</p>");
